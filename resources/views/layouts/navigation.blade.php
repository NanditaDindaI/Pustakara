            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->role === 'administrator')
                        ...
                        <x-nav-link :href="route('anggota-admin.index')" :active="request()->routeIs('anggota-admin.*')">
                            {{ __('Anggota') }}
                        </x-nav-link>
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('anggota.katalog.index')" :active="request()->routeIs('anggota.katalog.*')">
                            {{ __('Katalog Buku') }}
                        </x-nav-link>
                        <x-nav-link :href="route('anggota.riwayat.index')" :active="request()->routeIs('anggota.riwayat.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(Auth::user()->role === 'administrator')
                ...
                <x-responsive-nav-link :href="route('anggota-admin.index')" :active="request()->routeIs('anggota-admin.*')">
                    {{ __('Anggota') }}
                </x-responsive-nav-link>
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('anggota.katalog.index')" :active="request()->routeIs('anggota.katalog.*')">
                    {{ __('Katalog Buku') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('anggota.riwayat.index')" :active="request()->routeIs('anggota.riwayat.*')">
                    {{ __('Riwayat Peminjaman') }}
                </x-responsive-nav-link>
            @endif
        </div>
